...
router.get('/dashboard-data', async (req, res) => {
  ...
  try {
    ...
    // ! this could be a changing path issue for userId it is asking to remove foundUser (testing) // (trinary fix?)
    userId =
...
// TODO matt: I am trying to update that character without wiping existing values // 2 fields may have to be set in validation 1 for user and 1 for character and make the calls separately // even using $set is wiping them
